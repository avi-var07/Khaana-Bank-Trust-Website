        ...
        <div className={styles.grid}>
          ...
          <div className={styles.social}>
            ...
            <div className={styles.icons}>
              <a href="https://www.instagram.com/khana_bank_trust?igsh=MXcxc3R1dW9iOHJmdw==" target="_blank" rel="noopener noreferrer" className={styles.icon} aria-label="Instagram">
                <InstagramIcon />
              </a>
              <a href="https://www.facebook.com/khaanabank/" target="_blank" rel="noopener noreferrer" className={styles.icon} aria-label="Facebook">
                <FacebookIcon />
              </a>
              <a href="https://youtube.com/c/KhaanaBankTrust" target="_blank" rel="noopener noreferrer" className={styles.icon} aria-label="YouTube">
                <YouTubeIcon />
              </a>
            </div>
